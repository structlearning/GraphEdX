...
def test():
    test_data = get_ged_comb_data(conf, "test", file_logger)
...
def train():
    train_data = get_ged_comb_data(conf, "train", file_logger)
    val_data = get_ged_comb_data(conf, "val", file_logger)
...
if __name__ == "__main__":
    ...
    # assert conf.data_mode == 'asymmetric'
    # assert conf.dataset.use_cost_features
